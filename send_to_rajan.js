...
const TARGET_EMAIL = 'Bhadiyadararajan3@gmail.com';
const TARGET_USERNAME = 'Rajan_07';
...
async function sendToRajan() {
    try {
        console.log("🚀 Sending motivational email to Rajan (" + TARGET_EMAIL + ")...");
        ...
        console.log('✅ Email successfully sent to Rajan');

    } catch (error) {
        console.error('❌ Failed to send to Rajan:', error.message);
    }
}
