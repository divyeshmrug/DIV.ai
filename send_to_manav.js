...
const TARGET_EMAIL = 'manavtajpara@gmail.com';
const TARGET_USERNAME = 'Manav';
...
async function sendToManav() {
    try {
        console.log("🚀 Sending motivational email to Manav (" + TARGET_EMAIL + ")...");
        ...
        console.log('✅ Email successfully sent to Manav');

    } catch (error) {
        console.error('❌ Failed to send to Manav:', error.message);
    }
}
